...
@section('content')
    <div class="max-w-3xl mx-auto px-4 py-10">
        ...
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-500">Create a new project and assign it to a team.</p>
        </div>
        ...
        <div class="bg-white shadow rounded-lg overflow-hidden">
            <form action="{{ route('projects.store') }}" method="POST">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="project_name" id="project_name" value="{{ old('project_name') }}"
                            placeholder="e.g. Redesign Landing Page" required
                        ...
                        <div>
                            ...
                            <select name="client_id" id="client_id" required
                                ...
                                @foreach ($clients as $client)
                                    <option value="{{ $client->id }}" {{ (old('client_id') == $client->id || (isset($selected_client_id) && $selected_client_id == $client->id)) ? 'selected' : '' }}>
                                        {{ $client->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                ...
                                <input type="number" name="budget" id="budget" value="{{ old('budget') }}" min="1000"
                ...
                <div
                    class="px-6 py-4 bg-gray-50 text-right sm:px-6 flex items-center justify-end space-x-4 border-t border-gray-100">
